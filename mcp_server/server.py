...
def recommendations_list(
    ...
    try:
        ...
        return _ok({"row_count": len(rows), "recommendations": rows})
    except Exception as ex:
        return _err("recommendations_list", ex)
...
def recommendations_get(rec_id: int) -> str:
    ...
    try:
        ...
        if rec is None:
            return _ok({"error": f"No recommendation with id {rec_id}"})
        return _ok(rec)
    except Exception as ex:
        return _err("recommendations_get", ex)
...
def recommendations_add(
    ...
    try:
        ...
        return _ok({"inserted": rec})
    except Exception as ex:
        return _err("recommendations_add", ex)
...
def recommendations_update(
    ...
    try:
        ...
        if not fields:
            return _ok({"error": "Nothing to update — pass at least one field"})

        rec = recs.update_rec(rec_id, fields)
        return _ok({"updated": rec})
    except Exception as ex:
        return _err("recommendations_update", ex)
...
def recommendations_outcomes_pending() -> str:
    ...
    try:
        ...
        return _err("recommendations_outcomes_pending", ex)
...
def recommendations_measure_outcome(rec_id: int) -> str:
    ...
    try:
        ...
        return _ok({"rec_id": rec_id, "outcome": outcome})
    except Exception as ex:
        return _err("recommendations_measure_outcome", ex)
...
def recommendations_query(sql: str) -> str:
    ...
    try:
        ...
        return _err("recommendations_query", ex)
